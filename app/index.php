                ...
                <div class="row recipe">
                    ...
                    <div class="col-10 col-lg-8">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk
                            of the card's content. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque
                            cupiditate debitis ea eaque, hic ipsum magnam, nesciunt nobis nulla, quas quibusdam sed
                            vitae voluptate. Autem excepturi laudantium necessitatibus neque rem.</p>
